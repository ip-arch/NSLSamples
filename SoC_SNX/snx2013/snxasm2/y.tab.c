...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_RTYPE = 6,                      /* RTYPE  */
  YYSYMBOL_RTYPE1 = 7,                     /* RTYPE1  */
  YYSYMBOL_RTYPE0 = 8,                     /* RTYPE0  */
  YYSYMBOL_CTYPE0 = 9,                     /* CTYPE0  */
  YYSYMBOL_ITYPE = 10,                     /* ITYPE  */
  YYSYMBOL_DEFLBL = 11,                    /* DEFLBL  */
  YYSYMBOL_12_n_ = 12,                     /* '\n'  */
  YYSYMBOL_13_ = 13,                       /* ':'  */
  YYSYMBOL_14_ = 14,                       /* ','  */
  YYSYMBOL_15_ = 15,                       /* '('  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTEGER", "REG",
  "LABEL", "RTYPE", "RTYPE1", "RTYPE0", "CTYPE0", "ITYPE", "DEFLBL",
  "'\\n'", "':'", "','", "'('", "')'", "$accept", "program", "init",
  "function", "stmt", YY_NULLPTR
};
...
{
      -6,     9,    -6,    -6,    -5,    -3,     7,     8,     1,     2,
      11,    -6,    -6,    -6,     4,     5,    -6,    -6,     6,    12,
      13,     3,    10,    14,    15,    16,    17,    -6,    18,    -6,
      19,    20,    -6,    21,    -6
};
...
{
       5,     6,     7,     8,     9,    10,    24,    11,    25,     3,
      13,    14,    15,    16,    17,    18,    22,    23,    19,    20,
      21,    30,    31,     0,    26,     0,    27,     0,    29,     0,
      28,    32,     0,    34,     0,     0,    33
};

static const yytype_int8 yycheck[] =
{
       5,     6,     7,     8,     9,    10,     3,    12,     5,     0,
      13,     4,     4,    12,    12,     4,     4,     4,    14,    14,
      14,     4,     4,    -1,    14,    -1,    12,    -1,    12,    -1,
      15,    12,    -1,    12,    -1,    -1,    16
};
...
{
       0,    18,    19,     0,    20,     5,     6,     7,     8,     9,
      10,    12,    21,    13,     4,     4,    12,    12,     4,    14,
      14,    14,     4,     4,     3,     5,    14,    12,    15,    12,
       4,     4,    12,    16,    12
};
...
#line 1204 "y.tab.c"
  ...
  case 7: /* stmt: LABEL ':'  */
#line 84 "snxasm.y"
                                         { (yyval.nPtr) = opr(DEFLBL, 1, con((yyvsp[-1].iValue))); }
#line 1210 "y.tab.c"
    break;

  case 8: /* stmt: ITYPE REG ',' INTEGER '(' REG ')' '\n'  */
#line 86 "snxasm.y"
               { (yyval.nPtr) = opr(ITYPE,4, con((yyvsp[-7].iValue)), con((yyvsp[-6].iValue)), con((yyvsp[-4].iValue)), con((yyvsp[-2].iValue))); }
#line 1216 "y.tab.c"
    break;

  case 9: /* stmt: ITYPE REG ',' LABEL '\n'  */
#line 88 "snxasm.y"
               { (yyval.nPtr) = opr(ITYPE,3, con((yyvsp[-4].iValue)), con((yyvsp[-3].iValue)), con((yyvsp[-1].iValue))); }
#line 1222 "y.tab.c"
    break;

  case 10: /* stmt: CTYPE0 '\n'  */
#line 90 "snxasm.y"
               { (yyval.nPtr) = opr(CTYPE0,1, con((yyvsp[-1].iValue))); }
#line 1228 "y.tab.c"
    break;

  case 11: /* stmt: RTYPE0 '\n'  */
#line 92 "snxasm.y"
               { (yyval.nPtr) = opr(RTYPE0,1, con((yyvsp[-1].iValue))); }
#line 1234 "y.tab.c"
    break;

  case 12: /* stmt: RTYPE1 REG ',' REG '\n'  */
#line 94 "snxasm.y"
               { (yyval.nPtr) = opr(RTYPE1,3, con((yyvsp[-4].iValue)), con((yyvsp[-3].iValue)), id((yyvsp[-1].iValue))); }
#line 1240 "y.tab.c"
    break;

  case 13: /* stmt: RTYPE REG ',' REG ',' REG '\n'  */
#line 96 "snxasm.y"
             { (yyval.nPtr) = opr(RTYPE,4, con((yyvsp[-6].iValue)), con((yyvsp[-5].iValue)), con((yyvsp[-3].iValue)), con((yyvsp[-1].iValue))); }
#line 1246 "y.tab.c"
    break;
