...
set_global_assignment -name TOP_LEVEL_ENTITY NS12
...
set_location_assignment PIN_T13 -to b[0]
set_location_assignment PIN_T12 -to b[1]
set_location_assignment PIN_AA15 -to c[0]
set_location_assignment PIN_AB15 -to c[1]
set_location_assignment PIN_AA14 -to d[0]
set_location_assignment PIN_AA13 -to d[1]
set_location_assignment PIN_AB13 -to SW[8]
set_location_assignment PIN_AB12 -to do
