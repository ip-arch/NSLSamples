...
set_global_assignment -name TOP_LEVEL_ENTITY nsb0
...
set_location_assignment PIN_N2 -to g[0]
set_location_assignment PIN_N1 -to g[1]
set_location_assignment PIN_U2 -to g[2]
set_location_assignment PIN_U1 -to g[3]
