...
set_global_assignment -name TOP_LEVEL_ENTITY NS01
...
set_location_assignment PIN_N2 -to f[4]
set_location_assignment PIN_N1 -to f[5]
set_location_assignment PIN_U2 -to f[6]
set_location_assignment PIN_U1 -to f[7]
