...
set_global_assignment -name TOP_LEVEL_ENTITY NS15
...
#
# DE0_CV resources we use
#
# KEY[0] set to p_reset
set_location_assignment PIN_U7 -to p_reset  
# KEY[1] set to m_clock
set_location_assignment PIN_W9 -to m_clock  
...
set_location_assignment PIN_AA2 -to f[0]
set_location_assignment PIN_AA1 -to f[1]
set_location_assignment PIN_W2 -to f[2]
set_location_assignment PIN_Y3 -to f[3]
...
set_location_assignment PIN_U13 -to adr[0]
set_location_assignment PIN_V13 -to adr[1]
set_location_assignment PIN_T13 -to adr[2]
set_location_assignment PIN_T12 -to adr[3]
set_location_assignment PIN_AA15 -to in[0]
set_location_assignment PIN_AB15 -to in[1]
set_location_assignment PIN_AA14 -to in[2]
set_location_assignment PIN_AA13 -to in[3]
set_location_assignment PIN_AB13 -to read
set_location_assignment PIN_AB12 -to write
